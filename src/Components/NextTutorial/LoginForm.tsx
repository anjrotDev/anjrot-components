...
import { FaAt, FaKey, FaExclamationCircle } from "react-icons/fa";
...
export const LoginForm: FC<LoginFormProps> = ({ error, className, action, disabled, callbackurl, ...props }) => {
  return (
    <form className="space-y-3" action={action} {...props}>
